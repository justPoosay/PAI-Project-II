<template>
  <div class="flex flex-col gap-4">
    ...
    <fieldset class="flex flex-col gap-1">
      ...
      <input
        v-model="name"
        class="border-border focus:border-pink-2 rounded-md border px-3 py-2 transition focus:outline-none"
    ...
    <fieldset class="flex flex-col gap-1">
      ...
      <textarea
        ...
        class="border-border focus:border-pink-2 min-h-24 rounded-md border px-3 py-2 transition focus:outline-none"
