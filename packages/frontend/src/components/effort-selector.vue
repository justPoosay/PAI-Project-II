<template>
  <PopoverRoot v-model:open="isOpen">
    ...
    <PopoverPortal>
      <PopoverContent
        class="z-[999999] flex flex-col rounded-md border border-[#c0e1fd] bg-[#E2ECF5] p-1 text-[#333333] shadow-lg dark:border-[#615261] dark:bg-[#352635] dark:text-white min-w-28"
        align="start"
        :side-offset="5"
      >
        <button
