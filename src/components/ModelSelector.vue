<template>
  <div class="flex flex-col select-none">
    <div
      ...
      class="bg-white/15 backdrop-blur-sm px-3 py-1 rounded-lg data-[expanded=true]:rounded-b-none cursor-pointer transition-all duration-100 ease-out flex justify-center"
    ...
    <div
      :data-expanded="expanded"
      class="bg-gradient-to-b from-white/15 via-white/10 to-white/15 backdrop-blur-sm rounded-b-lg shadow-lg p-1 data-[expanded=false]:opacity-0 duration-100 ease-out"
    >
